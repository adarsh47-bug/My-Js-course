...
/*
// No. are represented internally in a 64 base 2 format.
// idea.
console.log(.1 + .2);
...
console.log(Math.max(3, 5, 1, 6, 38, 11, 22));
console.log(Math.max(3, 5, 1, 6, '38', '11', 22));
console.log(Math.max(3, 5, 1, 6, '38px', '11', 22));
...
const PI = 3.1_4_1_5;
// const PI = 3.14__15; //err
// const PI = 3.141_; //err
// const PI = _3.1415; //err
// const PI = 3_.1415; //err
// const PI = 3._1415; //err
console.log(PI);

// 📍 Don't use '_' in this functions
// Can cause bugs
// Also in APIs or some strings data..
console.log(Number('230_000')); //NaN
console.log(parseInt('230_000')); //230
*/
// 5
//idea. Working with BIGINT (ES2020)
/*
...
// 📍So there is a limit for numbers range
...
console.log(453643656246462n);
console.log(BigInt(453643656246462));

// Operations
console.log(10000n + 10000n);
console.log(5345465747568867865465657676765878710000n * 10000n);
// console.log(Math.sqrt(16n)); //err

// Mixing
const huge = 34545453463645775776487n;
const num = 23;
console.log(huge * BigInt(num));

// Exception
console.log(20n > 15);
console.log(20n === 20); //f //diff primitive type
console.log(typeof 22n);  //bigint
console.log(20n == 20); //t
console.log(huge + 'is REALLY big!!!');

// Divisions
console.log(11n / 3n); //3n ,cutoff decimal part
console.log(11 / 3);
*/
...
console.log(new Date('Jan 26 2024 12:00:15'));
console.log(new Date('December 15, 2003'));
console.log(new Date('December 2003'));
...
console.log(new Date(0)); //0 ms all initial unix time,Jan 01 1970
...
console.log(future.getTime()); //ms passed since initial unix time

console.log(new Date(2142237180000));

console.log(Date.now()); //1706261687020
...
console.log('Waiting...'); //this is c/l asynchronous js
